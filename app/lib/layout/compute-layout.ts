...
// correct branch when `self` is undefined — true in Node, never true inside
// a browser Worker (see elk-worker.ts, which needs a different construction).
// This is what makes computeLayout usable directly in Vitest without a real
// Worker.
